...
def layout_fct():
    ...
    #Meldung, wenn nicht die aktuellsten Daten angezeigt werden (älter als 40min = 2400s).
    ...
    return html.Div([
        ...
        #linker Abschnitt: Dropdown und Graph
        html.Div([
        ...
        html.Div([
            html.Div([
                ...
                html.H3(["Aktualisiert am ", tst_now_loc.day, ".", tst_now_loc.month, ".", tst_now_loc.year, " um ",
                         "{0:0=2d}".format(tst_now_loc.hour), ":", "{0:0=2d}".format(tst_now_loc.minute)]),
                html.H4(inet),
            ]),
        ...
        html.Div([
            ...
            html.Div([
                html.P(["Lufttemperatur um ", "{0:0=2d}".format((tst_now_loc.hour + s) % 24), ":",
                        "{0:0=2d}".format(tst_now_loc.minute), " Uhr"]),
            ...
            html.Div([
                ...
                html.H3(["vom ", tst_hist_loc.day, ".", tst_hist_loc.month, ".", tst_hist_loc.year, " um ",
                         "{0:0=2d}".format(tst_hist_loc.hour), ":", "{0:0=2d}".format(tst_hist_loc.minute)]),
            ]),
